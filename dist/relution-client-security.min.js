...
"use strict";angular.module("relutionClientSecurity").service("LoginService",["$q","$state","Base64","$rootScope","$relutionSecurityConfig","UserService","HeaderService",function(e,r,o,n,s,t,u){var i=this;this.userResponse=null,this.header=null,this.isLoggedIn=!1,this.basicAuth=null,this.form={username:{value:n.globals?n.globals.username:null,type:"text",required:!0},password:{value:null,type:"password",required:!0}},this.setUsername=function(e){i.form.username.value=e},this.setPassword=function(e){i.form.password.value=e},this.clearCredentials=function(){jQuery.ajaxSetup({headers:{Authorization:"Basic "}})},this.logon=function(){return i.basicAuth=o.encode(i.form.username.value+":"+i.form.password.value),jQuery.ajaxSetup({xhrFields:{withCredentials:!0}}),i.secureLogin()},this.success=function(o){return i.userResponse=o,i.isLoggedIn=!0,e.when(t.init(o)).then(function(){return r.go(s.forwardStateAfterLogin)})},this.complete=function(e,r){return u.init(e),i.header=e.getAllResponseHeaders()},this.error=function(e){return console.error("Login failed",e)},this.successLogout=function(){i.userResponse=null,i.isLoggedIn=!1,e.when(t.reset()).then(function(){return r.go(s.forwardStateAfterLogout)})},this.errorLogout=function(e){return console.error("Logout failed",e)},this.secureLogin=function(){if(!s.loginUrl)return console.error("please configure your loginUrl, $relutionSecurityConfig.loginUrl = secureloginUrl"),e.when(!1);var r={userName:i.form.username.value,password:i.form.password.value};return jQuery.ajax({type:"POST",headers:{"Content-Type":"application/json","Access-Control-Allow-Origin":"*"},url:s.loginUrl,data:JSON.stringify(r),success:i.success,error:i.error,complete:i.complete,dataType:"json"})},this.secureLogout=function(){return s.logoutUrl?jQuery.post(s.logoutUrl,i.successLogout):(console.error("please configure your logoutUrl, $relutionSecurityConfig.logoutUrl = secureloginUrl"),e.when(!1))}}]);
