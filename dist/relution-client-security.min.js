...
"use strict";angular.module("relutionClientSecurity").service("LoginService",["$q","$state","Base64","$rootScope","$relutionSecurityConfig","UserService",function(e,r,o,s,n,t){var u=this;this.userResponse=null,this.header=null,this.isLoggedIn=!1,this.basicAuth=null,this.form={username:{value:s.globals?s.globals.username:null,type:"text",required:!0},password:{value:null,type:"password",required:!0}},this.setUsername=function(e){u.form.username.value=e},this.setPassword=function(e){u.form.password.value=e},this.clearCredentials=function(){jQuery.ajaxSetup({headers:{Authorization:"Basic "}})},this.logon=function(){return u.basicAuth=o.encode(u.form.username.value+":"+u.form.password.value),jQuery.ajaxSetup({xhrFields:{withCredentials:!0}}),u.secureLogin()},this.success=function(e){return u.userResponse=e,u.isLoggedIn=!0,console.log("resp",e),t.init(e).then(function(){return r.go(n.forwardStateAfterLogin)})},this.complete=function(e,r){return u.header=e.getAllResponseHeaders()},this.error=function(e){return console.error("Login failed",e)},this.successLogout=function(){u.userResponse=null,u.isLoggedIn=!1,e.when(t.reset()).then(function(){return r.go(n.forwardStateAfterLogout)})},this.errorLogout=function(e){return console.error("Logout failed",e)},this.secureLogin=function(){if(!n.loginUrl)return console.error("please configure your loginUrl, $relutionSecurityConfig.loginUrl = secureloginUrl"),e.when(!1);var r={userName:u.form.username.value,password:u.form.password.value};return jQuery.ajax({type:"POST",headers:{"Content-Type":"application/json","Access-Control-Allow-Origin":"*"},url:n.loginUrl,data:JSON.stringify(r),success:u.success,error:u.error,complete:u.complete,dataType:"json"})},this.secureLogout=function(){return n.logoutUrl?jQuery.post(n.logoutUrl,u.successLogout):(console.error("please configure your logoutUrl, $relutionSecurityConfig.logoutUrl = secureloginUrl"),e.when(!1))}}]);
